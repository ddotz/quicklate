...
enum AppText {
    ...
    static let languagePackDownloadInProgress = localized(english: "Downloading language pack…", korean: "언어팩 다운로드 중…", japanese: "言語パックをダウンロード中…", chineseSimplified: "正在下载语言包…")
    ...
    static let settings = localized(english: "Settings", korean: "설정")
    static let openSettings = localized(english: "Open Settings", korean: "설정 열기")
    static let processingSettings = localized(english: "Processing", korean: "작업 방식")
    static let languageSettings = localized(english: "Languages", korean: "언어")
    static let modelAssetSettings = localized(english: "Language Packs", korean: "언어팩 / 모델 자산")
    static let recordingSettings = localized(english: "Recording & Save", korean: "기록 / 저장")
    static let translationQualitySettings = localized(english: "Translation Quality", korean: "번역 품질")
    static let translationRefinement = localized(english: "Context refinement", korean: "문맥 보정 번역")
    static let translationRefinementDescription = localized(english: "Keeps fast Apple translation first, then refines stable sentences locally when available.", korean: "빠른 Apple 번역을 먼저 표시하고, 가능한 경우 안정화된 문장만 로컬에서 문맥 보정합니다.")
    static let translationRefinementProvider = localized(english: "Refinement provider", korean: "보정 방식")
    static let translationRefinementAggressiveness = localized(english: "Refinement strength", korean: "보정 강도")
    static let translationRefinementOff = localized(english: "Off", korean: "끔")
    static let translationRefinementFoundationModels = localized(english: "Apple Foundation Model", korean: "Apple Foundation Model")
    static let translationRefinementMLX = localized(english: "Local LLM", korean: "로컬 LLM")
    static let translationRefinementConservative = localized(english: "Conservative", korean: "보수적")
    static let translationRefinementBalanced = localized(english: "Balanced", korean: "균형")
    static let translationRefinementQuality = localized(english: "Quality", korean: "품질 우선")
    static let glossary = localized(english: "Glossary", korean: "용어집")
    static let glossaryEnabled = localized(english: "Use glossary", korean: "용어집 사용")
    static let glossarySourceTerm = localized(english: "Source term", korean: "원문 용어")
    static let glossaryTargetTerm = localized(english: "Target term", korean: "번역 용어")
    static let glossaryNote = localized(english: "Note", korean: "메모")
    static let glossaryHardRule = localized(english: "Hard rule", korean: "고정 규칙")
    static let glossaryAddOrUpdate = localized(english: "Save term", korean: "용어 저장")
    static let glossaryEdit = localized(english: "Edit", korean: "수정")
    static let glossaryDelete = localized(english: "Delete", korean: "삭제")
    static let appAndPermissions = localized(english: "App & Permissions", korean: "앱 표시 / 권한")
    static let settingsSummary = localized(english: "Manage translation mode, languages, packs, captions, saved transcripts, and permissions.", korean: "번역 방식, 언어, 언어팩, 자막, 저장 기록, 권한을 한곳에서 관리합니다.")
